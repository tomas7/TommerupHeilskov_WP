			...
			<?php 
				...
				if(!is_single()) {
					  ...
					  if($using_masonry == true && $masonry_type == 'material' && has_post_thumbnail() ) {
							echo '<a class="img-link" href="' . get_permalink() . '"><span class="post-featured-img"><span class="video-play-button"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="600px" height="800px" x="0px" y="0px" viewBox="0 0 600 800" enable-background="new 0 0 600 800" xml:space="preserve"><path fill="none" d="M0-1.79v800L600,395L0-1.79z"></path> </svg></span><span class="wrap">'.get_the_post_thumbnail($post->ID, $img_size, array('title' => '')) .'</span></span></a>'; 
						}
			   }
